        ...
        <>
            <aside className="w-20 lg:w-64 border-r border-border bg-card/30 hidden md:flex flex-col sticky top-0 h-screen transition-all duration-300">
                ...
                <div className="p-4 border-t border-border/50 bg-background/20 backdrop-blur-sm space-y-4">
                    {/* Balance Card */}
                    <div className="bg-primary/10 rounded-xl p-4 hidden lg:block border border-primary/10 relative group">
                        <div className="flex items-center justify-between mb-1">
                            ...
                            <button
                                ...
                                className="p-1 hover:bg-white/10 rounded-full transition-colors text-primary"
                    ...
                    <button
                        onClick={() => setIsStoreOpen(true)}
                        className="lg:hidden flex flex-col items-center justify-center text-primary font-bold text-xs bg-primary/10 p-2 rounded-lg hover:bg-primary/20 transition-colors w-full"
                    >
                        <Trophy className="w-4 h-4 mb-1" />
                        {coins >= 1000 ? `${(coins / 1000).toFixed(1)}k` : coins}
                        <Plus className="w-3 h-3 mt-1 opacity-50" />
                    </button>
